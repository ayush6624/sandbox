...
func TestTransportValidation(t *testing.T) {
	tests := []struct {
		...
		{"private ipv6 ula", TransportPrivateProxy, "[fd00::1]:8080", "", "", false},
		{"private cgnat lower bound", TransportPrivateProxy, "100.64.0.0:8080", "", "", false},
		{"private cgnat upper bound", TransportPrivateProxy, "100.127.255.255:8080", "", "", false},
		{"private wildcard", TransportPrivateProxy, "0.0.0.0:8080", "", "", true},
		{"private ipv6 wildcard", TransportPrivateProxy, "[::]:8080", "", "", true},
		{"private public", TransportPrivateProxy, "8.8.8.8:8080", "", "", true},
		{"private hostname refused", TransportPrivateProxy, "localhost:8080", "", "", true},
		{"private link local refused", TransportPrivateProxy, "169.254.1.2:8080", "", "", true},
		{"private cgnat out of range", TransportPrivateProxy, "100.128.0.1:8080", "", "", true},
		{"private missing port", TransportPrivateProxy, "10.0.0.2", "", "", true},
